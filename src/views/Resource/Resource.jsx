...
const Resource = () => {
    ...
    return(
        <div style={{marginTop: "100px", marginBottom: '50px', width: "100%", background: "#fefefe", position: 'static', display: 'flex', alignItems: 'center', flexDirection: 'column'}}>
            ...
            >
                <svg style={{filter: "drop-shadow(0px -5px 5px rgb(0,118,220,0.20)", transform: "scaleY(0.5)", position: "absolute", zIndex: "1", top: smallerLayout ? 'calc(100% * .20)' : "calc(100% * .18)"}} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1440 320">
                ...
                <motion.div 
                    ...
                    initial="hidden"
                    animate="visible"
                    style={{width: smallerLayout ?  "90%" : '80%', zIndex: "3", marginTop: 'calc(100% * .12)', maxWidth: '1400px'}}
                >
